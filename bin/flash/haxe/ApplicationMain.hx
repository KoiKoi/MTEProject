...
import com.tipyx.games.mteproject.Main;
...
class ApplicationMain {
	...
	public static function main() {
		...
		nme.Lib.setPackage("Tipyx", "MTEProject", "com.tipyx.games.mteproject.MTEProject", "1.0.0");
	...
	private static function begin() {
		var hasMain = false;
		for (methodName in Type.getClassFields(com.tipyx.games.mteproject.Main))
		{
			if (methodName == "main")
			{
				hasMain = true;
		...
		if (hasMain)
		{
			Reflect.callMethod (com.tipyx.games.mteproject.Main, Reflect.field (com.tipyx.games.mteproject.Main, "main"), []);
		}
		else
		{
			var instance = Type.createInstance(com.tipyx.games.mteproject.Main, []);
...
class DocumentClass extends com.tipyx.games.mteproject.Main { }
