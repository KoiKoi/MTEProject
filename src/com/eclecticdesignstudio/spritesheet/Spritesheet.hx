...
class Spritesheet {
	...
	public var behaviors:StringMap<BehaviorData>;
	...
	public function new (image:BitmapData = null, frames:Array <SpritesheetFrame> = null, behaviors:StringMap<BehaviorData> = null, imageAlpha:BitmapData = null) {
		...
		if (behaviors == null) {
			...
			this.behaviors = new StringMap<BehaviorData> ();
